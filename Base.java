...
public interface Base {
    ...
    static double sin(double angle) { return Math.sin(angle); }
    ...
    static double cos(double angle) { return Math.cos(angle); }
    ...
    static double tan(double angle) { return Math.tan(angle); }
    ...
    static double asin(double angle) { return Math.asin(angle); }
    ...
    static double acos(double angle) { return Math.acos(angle); }
    ...
    // Output
    default void print() throws IOException { print(System.out); }
    ...
    default void print(Path path) throws IOException { Files.writeString(path, toString()); }
    ...
    default void print(File parent, String child) throws IOException { print(new java.io.File(parent, child)); }
    default void print(String parent, String child) throws IOException { print(new java.io.File(parent, child)); }

    default void print(URI uri) throws IOException { print(new File(uri, 'w')); }
    default void print(URL url) throws IOException { print(new File(url, 'w')); }

    static void print(Object ...objs) { for(Object o: objs) System.out.print(o); }
    ...
    static int randInt() { return random.nextInt(); }
    static int randInt(int upperBound) { return random.nextInt(upperBound); }
    static int randInt(int lowerBound, int upperBound) { return lowerBound + randInt(upperBound-lowerBound); }
    static int randInt(int lowerBound, int upperBound, int step) { return lowerBound + step*randInt((upperBound-lowerBound-1)/step - 1); }

    static double randDouble() { return random.nextDouble(); }
    static double randDouble(double upperBound) { return Math.random()*upperBound; }
    static double randDouble(double lowerBound, double upperBound) { return lowerBound + Math.random()*(upperBound-lowerBound); }
    static double randDouble(double lowerBound, double upperBound, double step) { return lowerBound + Math.random()*((upperBound-lowerBound-1)/step - 1); }

    static float randFloat() { return random.nextFloat(); }
    static float randFloat(float upperBound) { return (float)Math.random()*upperBound; }
    static float randFloat(float lowerBound, float upperBound) { return lowerBound + (float)Math.random()*(upperBound-lowerBound); }
    static float randFloat(float lowerBound, float upperBound, float step) { return lowerBound + (float)Math.random()*((upperBound-lowerBound-1)/step - 1); }

    static boolean randBoolean() { return random.nextBoolean(); }

    static long randLong() { return random.nextLong(); }
    static long randLong(long upperBound) { return (long) floor(Math.random()*upperBound); }
    static long randLong(long lowerBound, long upperBound) { return lowerBound + (long) floor(Math.random()*(upperBound-lowerBound)); }
    static long randLong(long lowerBound, long upperBound, long step) { return lowerBound + (long) floor(Math.random()*((upperBound-lowerBound-1)/step - 1)); }
}